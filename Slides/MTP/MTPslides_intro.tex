...
\begin{minipage}{0.55\textwidth}
 \hspace{1cm} \includegraphics[width= .85\textwidth]{plaatjes/cdf_uniform}
\end{minipage}
...
\begin{frame}{Multiple Tests}
    \begin{figure}
        \centering
        \includegraphics[width = \textwidth]{plaatjes/mt1.pdf}
...
\begin{frame}{Multiple Tests}
    \begin{figure}
        \centering
        \includegraphics[width = \textwidth]{plaatjes/mt2.pdf}
    \end{figure}
\end{frame}
...
\begin{frame}{Multiple Tests}
    \begin{figure}
        \centering
        \includegraphics[width = \textwidth]{plaatjes/mt3.pdf}
